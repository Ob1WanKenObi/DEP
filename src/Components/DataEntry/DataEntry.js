...
const DataEntry = (props) => {
    return (
        <Formik
            ...
            onSubmit={(values) => formSubmitHandler(values, props.submitData)}
            ...
            >
                ...
                <div style={{ background: "#e1e1f5", flex: 1, padding: 40, borderRadius: "20px" }}>
                    ...
                    <button type='submit' className="button-basic">SUBMIT</button>
                </div>
            </Form>
        </Formik >
    );
